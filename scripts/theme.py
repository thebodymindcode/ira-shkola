...
.znak{display:flex;align-items:center;gap:11px;font-family:var(--anons);font-size:21px;
  color:#F3EDE3;letter-spacing:.4px;white-space:nowrap}
...
.hero .fon img{width:100%;height:100%;object-fit:cover;object-position:50% 32%;opacity:.55}
...
@media(max-width:640px){.plyv{right:14px;bottom:14px;padding:12px 15px;font-size:14px}}
