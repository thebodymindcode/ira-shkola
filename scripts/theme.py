...
.plashki{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;margin-top:18px}
/* Число колонок подобрано так, чтобы ряды всегда были полными,
   а одинокая плашка не висела хвостом. */
@media(max-width:1160px){.plashki{grid-template-columns:repeat(4,minmax(0,1fr))}}
@media(max-width:860px){.plashki{grid-template-columns:repeat(2,minmax(0,1fr))}}
