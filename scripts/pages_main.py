...
def glavnaya(articles):
    naprav = [
        ...
        ('karta', 'Чёрный Гримуар', 'kursy/grimuar/', 'Живой курс по колоде Некрономикон: причина, а не картинка события.', 'Девять ступеней'),
        ('runa', 'Руны', 'kursy/runy/', 'Северная традиция: знаки, имена, поставы.', 'Двадцать четыре знака'),
        ('ogon', 'Бесы', 'kursy/besy/', 'Занятие в записи: кого зовут, о чём просят и чем расплачиваются.', '66 минут'),
