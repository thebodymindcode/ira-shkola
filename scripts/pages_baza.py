...
<h1>Разборы, к которым возвращаются</h1>
<p>{T('Длинные материалы школы: значения знаков, устройство колоды, домашние обереги, '
      'нечистая сила деревни. Каждый разбор собран по источникам и заканчивается тем, '
      'что можно сделать сегодня.')}</p>
