...
async def main():
    ...
    zadachi = [
      ('glavnaya', 'Школа магии и таро', 'Таро, ритуальная магия, руны и домашние обереги. Обучение у Ирины Волковой.', 'images/obrazy/glavnaya.jpg', 'Школа'),
      ('shkola', 'Как здесь учат', 'Закрытые каналы, задание после каждой темы, разбор работ вслух.', 'images/obrazy/shkola.jpg', 'Обучение'),
      ('kursy', 'Курсы школы', 'Шесть направлений: Геката, руны, бесы, таро, обереги, личная работа.', 'images/obrazy/kursy.jpg', 'Курсы'),
      ('gekata', 'Геката: ритуальная магия', 'Четыре ступени работы с богиней перекрёстков, ключей и факелов.', 'images/obrazy/gekata.jpg', 'Курс'),
      ('runy', 'Руны: старший футарк', 'Двадцать четыре знака, рунические поэмы, работа с поставом.', 'images/obrazy/runy.jpg', 'Курс'),
      ('besy', 'Славянская демонология', 'Кто такие бесы в народной вере и по каким правилам с ними обходились.', 'images/obrazy/besy.jpg', 'Курс'),
